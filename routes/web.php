...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/exams/result/{id}', [ExamController::class, 'result'])->name('exams.result');
    Route::get('/exams/result/{score}/{user_id}/{exam_id}', [ExamController::class, 'resultakhir'])->name('exams.resultakhir');
